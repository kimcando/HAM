...
def get_args():
    ...
    parser.add_argument('--input_size', type=int, default=224, help='target dataset used for training')
    ...
    parser.add_argument('--wandb_log', type=str2bool, required=False, default=False, help="Data directory")
    parser.add_argument('--exp_name', type=str, required=False, default="test", help="wandb experiments name")
